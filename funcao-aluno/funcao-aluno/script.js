...
function apresentar(){
    mostrar('saida1', 'Bem-vindo à aula! Jovem!!');
}
apresentar();
...
// function situacao(nota){
//   if (nota >= 6){
//     mostrar('saida5', 'Você foi aprovado!!');
//   }
//   else{
//     mostrar('saida5', 'Você está de recuperação!!');
//   }
// }
...
mostrar('saida6', 'Preço 100 -> paga ' + precoFinal(10));
...
let notas = [7,8,9,10];
mostrar('saida7', 'Soma de lista [7,8,9,10] = ' + somarLista(notas));
